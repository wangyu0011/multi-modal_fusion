%%
PATH='/.../DATA_EEG_fNIRS/';
load([PATH,'DATA_ERSP_theta.mat']);
load([PATH,'DATA_ERSP_alpha.mat']);
load([PATH,'DATA_ERSP_beta.mat']);
load([PATH,'DATA_ERSP_gamma.mat']);
load('Labels.mat');
PATH1='/.../DATA_weight/';
for s=1:30
    list_A=1:30;
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_theta23.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_theta13.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_theta12.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_alpha23.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_alpha13.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_alpha12.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_beta23.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_beta13.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_beta12.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_gamma23.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_gamma13.mat'],'data')
    clear data;
    %%%%%%%%%%%%%%%%
    ...
    data{1,1}=t_weight;
    data{1,2}=s_weight;
    save([PATH1,'sub_',num2str(s),'_ERSP_gamma12.mat'],'data')
    clear data;
end
