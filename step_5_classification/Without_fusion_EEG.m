...
%                     SVM_scores13(:,t)=scores(:,1);
        ...
        for kk1=1:27
            %%%%%%%%%%%%%%%
            M1_P1=reshape(SVM_scores12(kk1,1,:),1,8);
            M1_P1(M1_P1<0)=0;M1_P1(M1_P1>1)=1;
            M1_P2=-reshape(SVM_scores12(kk1,1,:),1,8);
            M1_P2(M1_P2<0)=0;M1_P2(M1_P2>1)=1;
            %%%%%%%%%%%%%%%
            M2_P1=reshape(SVM_scores13(kk1,1,:),1,8);
            M2_P1(M2_P1<0)=0;M2_P1(M2_P1>1)=1;
            M2_P3=-reshape(SVM_scores13(kk1,1,:),1,8);
            M2_P3(M2_P3<0)=0;M2_P3(M2_P3>1)=1;
            %%%%%%%%%%%%%%%
            M3_P2=reshape(SVM_scores23(kk1,1,:),1,8);
            M3_P2(M3_P2<0)=0;M3_P2(M3_P2>1)=1;
            M3_P3=-reshape(SVM_scores23(kk1,1,:),1,8);
