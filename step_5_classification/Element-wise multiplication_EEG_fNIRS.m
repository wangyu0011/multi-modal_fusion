%%
PATH0='/home/xu/桌面/EEG_fNIRS_fusion_nback/DATA_EEG_fNIRS/';
...
PATH='/home/xu/桌面/EEG_fNIRS_fusion_nback/DATA_weight/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Labels.mat');
for qq=1:25
    ACC=[];
    ...
    for s=1:26
        ...
        X12_train{9}=DATA_HbO12_train;X12_train{10}=DATA_HbR12_train;X12_train{11}=DATA_HbT12_train;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        X12_test{9}=DATA_HbO12_test;X12_test{10}=DATA_HbR12_test;X12_test{11}=DATA_HbT12_test;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        YY12=[];
        SVM_scores12=[];
        t=0;
...
%                     SVM_scores12(:,t)=scores(:,1);
        ...
        X23_train{9}=DATA_HbO23_train;X23_train{10}=DATA_HbR23_train;X23_train{11}=DATA_HbT23_train;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        X23_test{9}=DATA_HbO23_test;X23_test{10}=DATA_HbR23_test;X23_test{11}=DATA_HbT23_test;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        YY23=[];
        SVM_scores23=[];
        t=0;
...
%                     SVM_scores23(:,t)=scores(:,1);
        ...
        X13_train{9}=DATA_HbO13_train;X13_train{10}=DATA_HbR13_train;X13_train{11}=DATA_HbT13_train;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        X13_test{9}=DATA_HbO13_test;X13_test{10}=DATA_HbR13_test;X13_test{11}=DATA_HbT13_test;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
        YY13=[];
        SVM_scores13=[];
        t=0;
...
%                     SVM_scores13(:,t)=scores(:,1);
        ...
        for kk1=1:27
            %%%%%%%%%%%%%%%
            M1_P1=reshape(SVM_scores12(kk1,1,:),1,66);
            M1_P1(M1_P1<0)=0;M1_P1(M1_P1>1)=1;
            M1_P2=-reshape(SVM_scores12(kk1,1,:),1,66);
            M1_P2(M1_P2<0)=0;M1_P2(M1_P2>1)=1;
            %%%%%%%%%%%%%%%
            M2_P1=reshape(SVM_scores13(kk1,1,:),1,66);
            M2_P1(M2_P1<0)=0;M2_P1(M2_P1>1)=1;
            M2_P3=-reshape(SVM_scores13(kk1,1,:),1,66);
            M2_P3(M2_P3<0)=0;M2_P3(M2_P3>1)=1;
            %%%%%%%%%%%%%%%
            M3_P2=reshape(SVM_scores23(kk1,1,:),1,66);
            M3_P2(M3_P2<0)=0;M3_P2(M3_P2>1)=1;
            M3_P3=-reshape(SVM_scores23(kk1,1,:),1,66);
    ...
    save(['fusion_EEG_fNIRS_DST_',num2str(qq),'.mat'],'ACC_DST');
    save(['fusion_EEG_fNIRS_',num2str(qq),'.mat'],'ACC');
end
clear all
